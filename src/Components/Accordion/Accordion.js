        ...
        return (
            ...
            >
                <div className={`accordion-item faq${data.id}`} id={data.id}>
                    ...
                    >
                        <div className="accordion-body">{data.placeholder}</div>
                    </div>
                </div>
            </div>
        );
    });
    return <div className="container-fluid">{faq}</div>;
};
