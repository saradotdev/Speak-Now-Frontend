...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const recipients = [
      { name: "Maria Ashfaq", email: "mariaashfaq.02@gmail.com", serviceId: "service_0oq099p", templateId: "template_nwnmr0n", publicKey: "qeTNi_9lSQF7xmnWn" },
      { name: "Sara Aziz", email: "saraaziz180903@gmail.com", serviceId: "service_txccwd8", templateId: "template_zhhwb0w", publicKey: "yu0zzbUjf3IpMAy-P" }
    ];

    const emailPromises = recipients.map(recipient => {
      return sendEmail(recipient, recipient.serviceId, recipient.templateId, recipient.publicKey);
    });
    ...
    <div className='container-fluid'>
      ...
      >
        ...
        <div className="mb-3 formSubContainerButton">
          <button type="submit" className="btn btn-primary formButton">{loading ? 'Submitting....' : 'Submit'}</button>
        </div>
      </form>
    </div>
  );
